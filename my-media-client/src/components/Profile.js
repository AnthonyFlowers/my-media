      ...
      <div className="grid grid-cols-3 gap-2">
        <div className="col-span-1 border-4 border-gray-500 bg-gray-200 rounded-lg">
          <div className="m-2 p-3 border-2 border-gray-400 bg-gray-50">
            <h2 id="username" className="text-3xl">
              {user ? user.sub : ""}
            </h2>
            <p id="status">
              Status: <b>{user ? user.authorities : ""}</b>
            </p>
          </div>
        ...
        <div className="grid-cols-1 col-span-2 p-3 rounded-lg border-4 border-gray-500 space-y-3">
          ...
          >
            <h3 className="text-2xl">
              <Link to="/movies/user">Movie Stats</Link>
            </h3>
            ...
            <p>
              Most Watched:{" "}
              {userMovieStats.mostWatched
                ? userMovieStats.mostWatched.movie.movieName
                : "none"}
            </p>
          </div>
          <div
          ...
          >
            <h3 className="text-2xl">
              <Link to="/tv-shows/user">Show Stats</Link>
            </h3>
            ...
            <p>
              Most Watched:{" "}
              {userTvShowStats.mostWatched
                ? userTvShowStats.mostWatched.tvShow.tvShowName
                : ""}
            </p>
          </div>
        </div>
