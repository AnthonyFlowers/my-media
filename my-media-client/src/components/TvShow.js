            ...
            <div className="details">
                ...
                }
                {
                    success ? <div role="alert">
                        <p className="bg-green-500 text-white font-bold rounded px-4 py-2 mt-2">Show Added</p>
                    </div> : <></>
                }
                {
                    errs.length > 0 ? <div role="alert">
                        <p className="bg-orange-500 text-white font-bold rounded-t px-4 py-2 mt-2">Could not add that show</p>
                        <p className="border border-t-0 border-orange-400 rounded-b bg-orange-100 px-4 py-3 text-orange-700">
                            {!user ?
                                <>You need to be <Link className="link" to="/login">logged in</Link> to add shows to your list</> :
                                <>You already added that show to your list update it <Link className="link" to="/tv-shows/user">here</Link></>}
                        </p>
                    </div> : <></>
                }
            </div>
